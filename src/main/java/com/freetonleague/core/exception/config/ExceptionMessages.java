...
public class ExceptionMessages {
    ...
    public static final String TOURNAMENT_ACTIVE_ERROR = "Tournament is not active and modification forbidden. Please contact to organizers.";
    ...
    public static final String TOURNAMENT_SERIES_STATUS_FINISHED_ERROR = "Tournament series can be finished only with setting parameter 'hasNoWinner' or the winner of the series. Please try to set series winner and finished status simultaneously.";
    ...
    public static final String TOURNAMENT_MATCH_STATUS_FINISHED_ERROR = "Tournament match can be finished only with setting parameter 'hasNoWinner' or the winner of the match. Please try to set match winner and finished status simultaneously.";
